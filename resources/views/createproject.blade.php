		       ...
		       <div class="col-12 col-lg-12">
				...
				<div class="card-header">
				  ...
				  <div class="card-body" style="padding-top: 30px;">
				  	<div class="form-body">
					 <form class="row g-3" action="submitproject" id="submitproject" method="post" enctype="multipart/form-data">
					 	@csrf
					 	<div class="col-sm-12">
					 		<label for="inputFirstName" class="form-label">Project Title <span class="required" >*</span></label>
							<input type="text" class="form-control" id="title" name="title" placeholder="Project Title" maxlength="225" required>
					 	</div><br />
					 	<div class="col-sm-12">
					 	...
					 	<div class="row g-3">
							...
							<div class="col-sm-3">
						 	...
						 	<div class="col-sm-3">
								<label for="inputFirstName" class="form-label">End Date <span class="required" ></span></label required>
								<input type="date" name="enddate" id="enddate" readonly required class="form-control">
							</div>
						</div>
					</div>
					 	<div class="col-sm-12">
					 		<label for="inputFirstName" class="form-label">Project Description <span class="required" >*</span></label required>
							<textarea class="form-control" id="body" name="description" placeholder="Brief description of the project" maxlength="5000" style="height: 200px;"></textarea>
					 	</div>
					 	<div class="col-sm-12">
						<div class="row g-3">
						 	<div class="col-sm-6">
						 		<label for="inputFirstName" class="form-label">Contract Award/Other Documents</label>
